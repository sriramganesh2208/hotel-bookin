    ...
    <div>
      ...
      <div className="top">
        <div className="prices">
          <h3>Sort by:</h3>
          <Button variant="outlined" onClick={handleSortLowToHigh}>
            Low To High
          </Button>
          <Button variant="outlined" onClick={handleSortHighToLow}>
            High To Low
          </Button>
        </div>
            ...
            <div className="checkbox">
              ...
              <div className="checkboxContainer">
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={min === undefined && max === 2000}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={min === 6001 && max === undefined}
                      onChange={handlePriceChange}
                      name="over6001"
                    />
                  }
              ...
              <Button variant="contained" onClick={handleResetPriceRange}>
                Reset Price Range
              </Button>
            </div>
            ...
            <div className="checkbox">
              ...
              <div className="checkboxContainer">
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={accommodationTypes.cabin}
                      onChange={handleAccommodationTypeChange}
                      name="cabin"
                    />
                  }
